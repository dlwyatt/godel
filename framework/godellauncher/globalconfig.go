...
type GlobalConfig struct {
	...
	Executable string
	// The value of the "--wrapper" flag provided to the gödel executable.
	Wrapper string
	// The working directory on invocation.
	WorkingDir string
	// True if the "--debug" flag was provided to the gödel invocation.
	Debug bool
	// True if the "--version" flag was provided to the gödel invocation.
	Version bool
	// True if the "--help" flag was provided to the gödel invocation.
	Help bool
